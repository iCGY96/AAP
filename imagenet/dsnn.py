...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.sn1 = cext_neuron.MultiStepIFNode(detach_reset=True, backend='cupy')
        ...
        self.stride = stride
        self.sn2 = cext_neuron.MultiStepIFNode(detach_reset=True, backend='cupy')
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.stride = stride
        self.sn3 = cext_neuron.MultiStepIFNode(detach_reset=True, backend='cupy')
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False, connect_f=None):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                ...
                cext_neuron.MultiStepIFNode(detach_reset=True, backend='cupy')
            )
